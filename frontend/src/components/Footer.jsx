...
const Footer = () => {
  return (
    <div>
        ...
        <div>
            <hr />
            <p className='py-5 text-sm text-center'>Copyright 2024 Fashion Hub. All rights reserved.</p>
        </div>
    </div>
  )
}
